...
public class LottoSimulator {
	...
	public static Set<Integer> creatLotto(){
		/*
...
//		return winNum;
	...
	//보너스 번호를 생성하는 메서드
	public static int creatBonusNum(Set<Integer> win) {
		/*
...
//		}
	...
	//당첨 등수를 알려주는 메서드
	public static void checkLottoNum(Set<Integer> myLotto, 
			Set<Integer> win, int bonus) {
	...
	*/
		...
		if(count == 6) prizel1++;
			...
			if(myLotto.contains(bonus)) prizel2++;
			else prizel3++;
		} 
		else if (count == 4) prizel4++;
		else if (count == 3) prizel5++;
		else failCnt++;
...
//		else failCnt++; //꽝
	...
	public static void main(String[] args) {
		...
		Set<Integer> win = creatLotto();
		
		//보너스번호도 하나 고정시키세요.
		int bonus = creatBonusNum(win);
		...
		int paper = 0; //로또 구매 횟수 체크
		while(true) {
			Set<Integer> myLotto = creatLotto();
			paper++;
			checkLottoNum(myLotto, win, bonus);
			
			if(prizel1==1) {
				System.out.println("====================");
				System.out.println("1등 당첨!!");
				System.out.println("1등 당첨까지 누적 당첨 현황");
				System.out.println("2등: " + prizel2 + "회");
				System.out.println("3등: " + prizel3 + "회");
				System.out.println("4등: " + prizel4 + "회");
				System.out.println("5등: " + prizel5 + "회");
				System.out.println("꽝: " + failCnt + "회");
				System.out.println("=====================");
				System.out.println("1등 한번 되려고 구매한 로또 금액: " + (paper*1000L) + "원");
				break;
			} else {
				System.out.println("로또 " + paper + "번째 구매중");
			}
