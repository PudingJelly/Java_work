...
public class StringMethod {
	...
	public static void main(String[] args) {
		...
		//substring(begin, end)
		//문자열을 범위 지정하여 추출
		String ss1 = str.substring(1, 5); // 1번이상 5미만
		...
		int idx1 = str.indexOf("l"); // 앞에서부터 인덱스 찾음
		System.out.println("idx1: " + idx1);

		int idx2 = str.lastIndexOf("l"); //뒤에서 부터 인덱스 찾음
		...
		//replace(old, new)
		//기존 문자열 내부의 old 값을 모두 찾아서 new 문자열로 일괄 변경.
